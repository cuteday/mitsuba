...
class BDPM1Integrator : public SamplingIntegrator {
public:
    BDPM1Integrator(const Properties &props) : SamplingIntegrator(props),
    ...
    BDPM1Integrator(Stream *stream, InstanceManager *manager)
...
MTS_IMPLEMENT_CLASS_S(BDPM1Integrator, false, SamplingIntegrator)
MTS_EXPORT_PLUGIN(BDPM1Integrator, "Photon map integrator");
MTS_NAMESPACE_END
